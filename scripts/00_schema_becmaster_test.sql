...
CREATE TABLE IF NOT EXISTS admin.merge_requests (
    ...
    record_counts JSONB NOT NULL DEFAULT '{}',  -- map: table_name -> row count
...
CREATE TABLE IF NOT EXISTS staging.admin (
    ...
    "lastModifiedUTC" TIMESTAMPTZ DEFAULT now(),
    "modifiedBy" TEXT,
    PRIMARY KEY (merge_request_id, plot)
);
...
-- staging.metadata: Mirror of core.metadata with change tracking
...
-- staging.hierarchy: Mirror of core.hierarchy with change tracking
CREATE TABLE IF NOT EXISTS staging.hierarchy (
    id BIGINT PRIMARY KEY,
    _name TEXT,
    parent BIGINT,
    _level BIGINT,
...
-- staging.humus: Mirror of core.humus with change tracking
CREATE TABLE IF NOT EXISTS staging.humus (
    merge_request_id INTEGER NOT NULL REFERENCES admin.merge_requests(id) ON DELETE CASCADE,
    id BIGINT NOT NULL,
    plotnumber TEXT,
    horizon TEXT,
...
-- staging.mineral: Mirror of core.mineral with change tracking
CREATE TABLE IF NOT EXISTS staging.mineral (
    merge_request_id INTEGER NOT NULL REFERENCES admin.merge_requests(id) ON DELETE CASCADE,
    id BIGINT NOT NULL,
    plotnumber TEXT,
    horizon TEXT,
...
-- staging.other: Mirror of core.other with change tracking
CREATE TABLE IF NOT EXISTS staging.other (
    merge_request_id INTEGER NOT NULL REFERENCES admin.merge_requests(id) ON DELETE CASCADE,
    id BIGINT NOT NULL,
    plotnumber TEXT,
    dataname TEXT,
...
-- staging.herbarium: Mirror of core.herbarium with change tracking
CREATE TABLE IF NOT EXISTS staging.herbarium (
    merge_request_id INTEGER NOT NULL REFERENCES admin.merge_requests(id) ON DELETE CASCADE,
    ...
    "lastModifiedUTC" TIMESTAMPTZ DEFAULT now(),
    "modifiedBy" TEXT,
    PRIMARY KEY (merge_request_id, recid)
);

-- staging.profile: Mirror of core.profile with change tracking
CREATE TABLE IF NOT EXISTS staging.profile (
    _order BIGINT,
    _table TEXT,
    field TEXT,
    _operator TEXT,
...
-- staging.veg_profile: Mirror of core.veg_profile with change tracking
CREATE TABLE IF NOT EXISTS staging.veg_profile (
    _order BIGINT,
    _table TEXT,
    field TEXT,
    _operator TEXT,
...
-- staging.lump: Mirror of core.lump with change tracking
CREATE TABLE IF NOT EXISTS staging.lump (
    lumpcode TEXT PRIMARY KEY,
    sppcode TEXT,
    _use BIGINT,
    "baseRowVersion" INTEGER,
...
-- staging.theme: Mirror of core.theme with change tracking
CREATE TABLE IF NOT EXISTS staging.theme (
    sppcode TEXT PRIMARY KEY,
    lumpcode TEXT,
    scientificname TEXT,
    colourcode BIGINT,
...
-- staging.audit: Mirror of core.audit with change tracking
CREATE TABLE IF NOT EXISTS staging.audit (
    id BIGINT PRIMARY KEY,
    project TEXT,
    _user TEXT,
    plotnumber TEXT,
