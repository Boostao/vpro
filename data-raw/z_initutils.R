...
outputdir <- file.path(getwd(), "inst", "data", "pics")
dir.create(outputdir, recursive = TRUE, showWarnings = FALSE)
source("data-raw/pics/init.R")

outputdir <- file.path(getwd(), "inst", "data")
dir.create(outputdir, recursive = TRUE, showWarnings = FALSE)
source("data-raw/messages/init.R")
source("data-raw/lists/init.R")
source("data-raw/metadata/init.R")
source("data-raw/vpro/init.R")
source("data-raw/user/init.R")

outputdir <- file.path(getwd(), "inst", "data", "projects")
dir.create(outputdir, recursive = TRUE, showWarnings = FALSE)
source("data-raw/projects/init.R")
