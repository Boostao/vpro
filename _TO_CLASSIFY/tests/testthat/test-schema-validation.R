...
compare_schemas <- function(schema1, schema2, table_name) {
  ...
  for (col in common_cols) {
    ...
    if (type1 != type2) {
      result$match <- FALSE
      result$type_mismatches <- c(result$type_mismatches, paste0(col, " (DuckDB: ", type1, " vs PG: ", type2, ")"))
    }
  }
...
format_comparison_error <- function(comp, db1 = "DuckDB", db2 = "PostgreSQL") {
  ...
  if (comp$cols1 > 0 || comp$cols2 > 0) {
    parts <- c(parts, sprintf("  %s columns: %d, %s columns: %d", db1, comp$cols1, db2, comp$cols2))
  }
...
# ---- Core Tables Tests ----
testthat::test_that("core.admin table schema matches", {
  run_schema_test("core", "admin")
})
testthat::test_that("core.metadata table schema matches", {
  run_schema_test("core", "metadata")
})
testthat::test_that("core.hierarchy table schema matches", {
  run_schema_test("core", "hierarchy")
})
testthat::test_that("core.env table schema matches", {
  run_schema_test("core", "env")
})
testthat::test_that("core.humus table schema matches", {
  run_schema_test("core", "humus")
})
testthat::test_that("core.mineral table schema matches", {
  run_schema_test("core", "mineral")
})
testthat::test_that("core.other table schema matches", {
  run_schema_test("core", "other")
})
testthat::test_that("core.veg table schema matches", {
  run_schema_test("core", "veg")
})
testthat::test_that("core.herbarium table schema matches", {
  run_schema_test("core", "herbarium")
})
testthat::test_that("core.su table schema matches", {
  run_schema_test("core", "su")
})
testthat::test_that("core.profile table schema matches", {
  run_schema_test("core", "profile")
})
testthat::test_that("core.veg_profile table schema matches", {
  run_schema_test("core", "veg_profile")
})
testthat::test_that("core.lump table schema matches", {
  run_schema_test("core", "lump")
})
testthat::test_that("core.theme table schema matches", {
  run_schema_test("core", "theme")
})
testthat::test_that("core.audit table schema matches", {
  run_schema_test("core", "audit")
})

# ---- Staging Tables Tests ----
testthat::test_that("staging.admin table schema matches", {
  run_schema_test("staging", "admin")
})
testthat::test_that("staging.metadata table schema matches", {
  run_schema_test("staging", "metadata")
})
testthat::test_that("staging.hierarchy table schema matches", {
  run_schema_test("staging", "hierarchy")
})
testthat::test_that("staging.env table schema matches", {
  run_schema_test("staging", "env")
})
testthat::test_that("staging.humus table schema matches", {
  run_schema_test("staging", "humus")
})
testthat::test_that("staging.mineral table schema matches", {
  run_schema_test("staging", "mineral")
})
testthat::test_that("staging.other table schema matches", {
  run_schema_test("staging", "other")
})
testthat::test_that("staging.veg table schema matches", {
  run_schema_test("staging", "veg")
})
testthat::test_that("staging.herbarium table schema matches", {
  run_schema_test("staging", "herbarium")
})
testthat::test_that("staging.su table schema matches", {
  run_schema_test("staging", "su")
})
testthat::test_that("staging.profile table schema matches", {
  run_schema_test("staging", "profile")
})
testthat::test_that("staging.veg_profile table schema matches", {
  run_schema_test("staging", "veg_profile")
})
testthat::test_that("staging.lump table schema matches", {
  run_schema_test("staging", "lump")
})
testthat::test_that("staging.theme table schema matches", {
  run_schema_test("staging", "theme")
})
testthat::test_that("staging.audit table schema matches", {
  run_schema_test("staging", "audit")
})

# ---- Lists Tables Tests ----
testthat::test_that("lists.spplist table schema matches", {
  run_schema_test("lists", "spplist")
})
testthat::test_that("lists.layercode table schema matches", {
  run_schema_test("lists", "layercode")
})
testthat::test_that("lists.usyszonelist table schema matches", {
  run_schema_test("lists", "usyszonelist")
})
testthat::test_that("lists.usyssubzonelist table schema matches", {
  run_schema_test("lists", "usyssubzonelist")
})
testthat::test_that("lists.usystableoflists table schema matches", {
  run_schema_test("lists", "usystableoflists")
})
testthat::test_that("lists.usyssppattributes table schema matches", {
  run_schema_test("lists", "usyssppattributes")
})
