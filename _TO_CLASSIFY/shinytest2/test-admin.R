...
verify_db_state <- function(query, expected_rows = NULL, description = "DB check", db_path = "data/vpro.duckdb") {
  ...
  if (!is.null(expected_rows)) {
    expect_equal(nrow(result), expected_rows, label = paste0(description, " - row count"))
  }
...
describe("Admin - Project Metadata CRUD", {
  test_that("Admin tab is accessible", {
    ...
    expect_equal(current_tab, "Administration", label = "Admin tab accessible")
  })
  ...
  test_that("Project Metadata panel renders", {
    ...
    expect_true(proj_select_exists, label = "Project selector exists in Admin")
  })
  ...
  test_that("New Project button exists", {
    ...
    expect_true(new_proj_btn, label = "New Project button exists")
  })
  ...
  test_that("Delete Project button exists", {
    ...
    expect_true(del_proj_btn, label = "Delete Project button exists")
  })
  ...
  test_that("Save Project button exists", {
    ...
    expect_true(save_btn_exists, label = "Save Project button exists")
  })
  ...
  test_that("Project selection populates form fields", {
    ...
    if (!has_projects()) {
      skip("No projects in metadata database")
    }
    ...
    if (nrow(projects) > 0) {
      ...
      expect_equal(selected_proj, test_proj, label = "Project selection updates form")
    }
  })
  ...
  test_that("Project form header updates with selection", {
    ...
    expect_true(!is.null(form_header), label = "Project form header renders")
  })
...
describe("Admin - Code Maintenance", {
  test_that("Code Maintenance panel is accessible", {
    ...
    if (!has_lists_db()) {
      skip("Lists database not available")
    }
    ...
    expect_true(code_select_exists, label = "Code list selector exists")
  })
  ...
  test_that("Lookup list selector populates", {
    ...
    expect_true(nrow(lists) > 0, label = "Lookup lists available in database")
  })
  ...
  test_that("Code table renders with data", {
    ...
    expect_true(code_dt_exists, label = "Code maintenance datatable renders")
  })
  ...
  test_that("Add Row button exists in Code Maintenance", {
    ...
    expect_true(add_row_btn_exists, label = "Add Row button exists in Code Maintenance")
  })
  ...
  test_that("Save All Items button exists", {
    ...
    expect_true(save_btn_exists, label = "Save All Items button exists")
  })
  ...
  test_that("Refresh Lists button exists", {
    ...
    expect_true(refresh_btn_exists, label = "Refresh Lists button exists")
  })
...
describe("Admin - Master Site Units", {
  test_that("Master Site Units panel is accessible", {
    ...
    expect_true(master_level_exists, label = "Master level selector exists")
  })
  ...
  test_that("Master unit datatable renders", {
    ...
    expect_true(master_dt_exists, label = "Master site units datatable renders")
  })
  ...
  test_that("Master unit Add Row button exists", {
    ...
    expect_true(add_btn_exists, label = "Master Add Row button exists")
  })
  ...
  test_that("Master unit Save button exists", {
    ...
    expect_true(save_btn_exists, label = "Master Save button exists")
  })
  ...
  test_that("Master Refresh button exists", {
    ...
    expect_true(refresh_btn_exists, label = "Master Refresh button exists")
  })
})
...
describe("Admin - Master Audit", {
  test_that("Master Audit panel is accessible", {
    ...
    expect_true(audit_user_exists, label = "Master Audit user filter exists")
  })
  ...
  test_that("Master Audit datatable renders", {
    ...
    expect_true(audit_dt_exists, label = "Master Audit datatable renders")
  })
  ...
  test_that("Master Audit export button exists", {
    ...
    expect_true(export_btn_exists, label = "Master Audit export button exists")
  })
})
...
describe("Images & Maps Module", {
  test_that("Images tab is accessible", {
    ...
    current_tab <- safe_get_value(app, input = "main_tabs")
    expect_equal(current_tab, "Images & Maps", label = "Images & Maps tab accessible")
  })
  ...
  test_that("Image gallery renders for plot with images", {
    ...
    expect_true(!is.null(gallery_ui), label = "Image gallery UI renders")
  })
  ...
  test_that("KML download button exists", {
    ...
    expect_true(kml_btn_exists, label = "KML download button exists")
  })
  ...
  test_that("Location debug output renders", {
    ...
    expect_true(!is.null(loc_debug), label = "Location debug info renders")
  })
