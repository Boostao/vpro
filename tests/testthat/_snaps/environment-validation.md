# environment validation checks context and reference inputs

    Code
      vpro_validate_environment_codes(context, reference_path)
    Condition
      Error:
...
---
    ...
    Code
      vpro_validate_environment_codes(context, "missing.db")
    Condition
      Error:
